...
<div class="portfolio-wrap">
	...
	<div class="portfolio radius-bottom <?php if ( 'two' == get_theme_mod('natural_lite_portfolio_columns', 'three')) { ?>portfolio-half<?php } if ( 'three' == get_theme_mod('natural_lite_portfolio_columns', 'three')) { ?>portfolio-third<?php } ?>">
		...
		<?php $video = natural_lite_first_embed_media(); ?>
			...
			<li class="portfolio-item <?php if ( 'one' == get_theme_mod('natural_lite_portfolio_columns', 'three')) { ?>single<?php } if ( 'two' == get_theme_mod('natural_lite_portfolio_columns', 'three')) { ?>half<?php } if ( 'three' == get_theme_mod('natural_lite_portfolio_columns', 'three')) { ?>third<?php } ?> <?php $allClasses = get_post_class(); foreach ($allClasses as $class) { echo $class . " "; } ?>" data-filter="category-<?php $allClasses = get_post_class(); foreach ($allClasses as $class) { echo $class . " "; } ?>">
