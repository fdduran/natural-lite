	...
	<div class="row">
		...
		<div class="featured-pages radius-full">
			...
			<div class="holder third first">
				<?php $recent = new WP_Query('page_id='.get_theme_mod('natural_lite_page_left', '0')); while($recent->have_posts()) : $recent->the_post(); ?>
					<?php get_template_part( 'content/home', 'page' ); ?>
				<?php endwhile; wp_reset_postdata(); ?>
			</div>
			
			<div class="holder third">
				<?php $recent = new WP_Query('page_id='.get_theme_mod('natural_lite_page_mid', '0')); while($recent->have_posts()) : $recent->the_post(); ?>
					<?php get_template_part( 'content/home', 'page' ); ?>
				<?php endwhile; wp_reset_postdata(); ?>
			</div>
			
			<div class="holder third last">
				<?php $recent = new WP_Query('page_id='.get_theme_mod('natural_lite_page_right', '0')); while($recent->have_posts()) : $recent->the_post(); ?>
					<?php get_template_part( 'content/home', 'page' ); ?>
				<?php endwhile; wp_reset_postdata(); ?>
			</div>
